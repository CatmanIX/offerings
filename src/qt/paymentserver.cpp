...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Offering: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Offering: click-to-pay handler");
    else
...
{
    // clicking on Offering: URLs creates FileOpen events on the Mac:
